...
CREATE TABLE `shoppingcart_products` (
  ...
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
INSERT INTO `shoppingcart_products` (`ID`, `name`, `image`, `price`, `description`, `quantity`, `valid`) VALUES
